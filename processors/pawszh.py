...
""" PAWS-X-Zh utils (dataset loading and evaluation) """
...
class PAWSXZhProcessor(DataProcessor):
    """Processor for the PAWS-X Zh dataset.
    ...
    def get_examples(self, data_dir, split='train'):
        """See base class."""
        examples = []
        dataset = load_dataset('paws-x', 'zh', split=split)
        ...
        for i, example in enumerate(dataset):
            ...
            label = example['label']
            label = PAWSXZhProcessor.label_map[label]
