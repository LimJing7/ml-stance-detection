...
class RItaProcessor(DataProcessor):
    """Processor for the r-ita dataset.
    Adapted from https://github.com/google-research/bert/blob/f39e881b169b9d53bea03d2d341b31707a6c052b/run_classifier.py#L207"""

    label_map = {'agains': 'against',
                 'favor': 'in favour',
                 'none': 'neutral'}
    language = 'it'
    ...
    def get_examples(self, data_dir, split='train'):
      """See base class."""
      examples = []
      df = pd.read_csv(os.path.join(data_dir, f"r-ita-{split}.csv"), quotechar='"', sep=',')
