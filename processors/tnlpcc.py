...
class tNLPCCProcessor(DataProcessor):
    ...
    contexts_dict = {'IphoneSE': 'iPhone SE是苹果公司在2016年3月21日10点在美国加州库比蒂诺总部发布的电子产品。',
                     ...
                     'opposite of IphoneSE': 'iPhone SE是苹果公司在2016年3月21日10点在美国加州库比蒂诺总部发布的电子产品。',
                     'opposite of 俄罗斯在叙利亚的反恐行动': '俄罗斯在叙利亚内战的军事介入指俄罗斯在叙利亚内战中采取的军事行动,俄军从2015年9月30日开始向叙利亚反政府武装展开空袭。在此之前俄罗斯已经向叙利亚政府提供武器,俄罗斯的军事行动也得到叙利亚政府同意。',
                     'opposite of 开放二胎': '2015年10月26日至29日,中国共产党第十八届中央委员会第五次全体会议提出坚持计划生育的基本国策,完善人口发展战略,“全面实施一对夫妇可生育两个孩子政策”。中国从1980年开始,推行了35年的城镇人口独生子女政策真正宣告终结。',
                     'opposite of 春节放鞭炮': '放鞭炮是中国传统民间习俗,但是因为担忧雾霾、噪声扰城,已有近700城市禁放、限放鞭炮',
                     'opposite of 深圳禁摩限电': '2016年3月22日起到6月底,在全市开展禁摩限电源头治理行动。地铁口、公交站点、口岸、商业繁华区等区域聚集非法拉客的,一律拘留;违规使用电动三轮车的,4月1日起一律拘留。'}
    ...
    def get_examples(self, data_dir, split='train'):
      ...
      for (i, line) in enumerate(lines):
        ...
        topic = line[1]
        text = line[2]
        context = tNLPCCProcessor.contexts_dict[topic]
